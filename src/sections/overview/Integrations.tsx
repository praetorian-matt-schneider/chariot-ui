...
// Buckets
export const IntegrationBuckets = {
  code: [Integration.github, Integration.gitlab, Integration.snyk],
  cloud: [
    Integration.amazon,
    Integration.gcp,
    Integration.azure,
    Integration.digitalocean,
    Integration.ibmcloud,
    Integration.gsuite,
    Integration.godaddy,
    Integration.ns1,
    Integration.orca,
  ...
  scanner: [Integration.nessus, Integration.nexpose, Integration.r7],
  cti: [
    Integration.shodan,
    Integration.securitytrails,
    Integration.greynoise,
    Integration.mandiant,
    Integration.vulndb,
    Integration.securityopscenter,
    Integration.jupiterone,
    Integration.runzero,
    Integration.wiz,
  ],
};
